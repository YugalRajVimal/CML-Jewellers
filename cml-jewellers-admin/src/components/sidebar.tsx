...
import {
  ...
  Wallet, Users, TicketPercent, Image as ImageIcon, ShieldCheck, ScrollText, ChevronRight, BarChart3, CreditCard, Settings as SettingsIcon,
} from "lucide-react";
...
const NAV: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/payments", label: "Payments", icon: CreditCard, perm: "payment:read" },
  ...
  {
    label: "Insights",
    items: [{ href: "/sales", label: "Sales", icon: BarChart3, perm: "sales:read" }],
  },
  {
    label: "Customers",
    items: [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/audit-log", label: "Audit log", icon: ScrollText, perm: "audit:read" },
      // Reuses role:manage — there's no dedicated "settings:manage" permission
      // yet for this one site-wide toggle; split it out if more settings get added.
      { href: "/settings", label: "Settings", icon: SettingsIcon, perm: "role:manage" },
    ],
  },
];
